...
- A bootstrap one-liner script (option (b) from brainstorm). Justin chose docs-only because curl-pipe-bash is a tough sell to security-conscious CDW coworkers.
