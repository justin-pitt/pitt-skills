...
**Example operational threshold**: Critical severity + score 700+ → block across enforcement points.
...
| **Cases vs Issues** | XSIAM uses "cases" and "issues" in analyst contexts, not "incidents" |
