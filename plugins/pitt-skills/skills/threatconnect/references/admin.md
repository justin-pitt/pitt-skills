...
- **Critical severity + score 700+**: Auto-block across your enforcement grid
...
**Feed effectiveness for the enforcement grid:**
When feed value is measured by how often its indicators trigger automated blocking, track:
