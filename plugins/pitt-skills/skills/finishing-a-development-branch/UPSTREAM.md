...
- **Path within repo:** `skills/finishing-a-development-branch/`
...
- The bundle vendored from `skills/finishing-a-development-branch/` is byte-identical to upstream at the SHA above (apart from the frontmatter `license:` insertion noted above).
