...
- **Path within repo:** `skills/brainstorming/`
...
- The bundle vendored from `skills/brainstorming/` is byte-identical to upstream at the SHA above (apart from the frontmatter `license:` insertion noted above).
