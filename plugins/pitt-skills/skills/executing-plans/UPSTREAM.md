...
- **Path within repo:** `skills/executing-plans/`
...
- The bundle vendored from `skills/executing-plans/` is byte-identical to upstream at the SHA above (apart from the frontmatter `license:` insertion noted above).
