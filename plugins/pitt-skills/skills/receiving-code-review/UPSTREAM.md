...
- **Path within repo:** `skills/receiving-code-review/`
...
- The bundle vendored from `skills/receiving-code-review/` is byte-identical to upstream at the SHA above (apart from the frontmatter `license:` insertion noted above).
