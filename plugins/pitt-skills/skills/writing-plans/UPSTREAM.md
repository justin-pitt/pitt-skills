...
- **Path within repo:** `skills/writing-plans/`
...
- The bundle vendored from `skills/writing-plans/` is byte-identical to upstream at the SHA above (apart from the frontmatter `license:` insertion noted above).
