...
- **Path within repo:** `skills/writing-skills/`
...
- The bundle vendored from `skills/writing-skills/` is byte-identical to upstream at the SHA above (apart from the frontmatter `license:` insertion noted above).
