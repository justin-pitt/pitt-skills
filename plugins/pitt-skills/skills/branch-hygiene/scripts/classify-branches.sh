...
echo
echo "NOTE: git branch -d REFUSES a SquashMerged branch - its commits are not"
echo "ancestors of $BASE. The merged PR is the evidence, not git ancestry."
echo "Use -D for SquashMerged only, and only after confirming the label."
