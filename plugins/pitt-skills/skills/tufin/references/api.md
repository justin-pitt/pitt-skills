...
<ticket_info>
  ...
  <requester>
    <id>42</id><name>admin</name><email>admin@example.com</email>
  </requester>
  <current_stage>
...
> NEEDS VERIFICATION: header name. Confirm against an actual response from your R25-1 PHF3 appliance.
