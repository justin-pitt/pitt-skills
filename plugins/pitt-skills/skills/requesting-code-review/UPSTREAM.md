...
- **Path within repo:** `skills/requesting-code-review/`
...
- The bundle vendored from `skills/requesting-code-review/` is byte-identical to upstream at the SHA above (apart from the frontmatter `license:` insertion noted above).
