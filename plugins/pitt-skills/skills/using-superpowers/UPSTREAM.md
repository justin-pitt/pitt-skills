...
- **Path within repo:** `skills/using-superpowers/`
...
- The bundle vendored from `skills/using-superpowers/` is byte-identical to upstream at the SHA above (apart from the frontmatter `license:` insertion noted above).
