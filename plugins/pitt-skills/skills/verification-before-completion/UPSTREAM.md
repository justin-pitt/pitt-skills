...
- **Path within repo:** `skills/verification-before-completion/`
...
- The bundle vendored from `skills/verification-before-completion/` is byte-identical to upstream at the SHA above (apart from the frontmatter `license:` insertion noted above).
