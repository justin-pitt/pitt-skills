...
- **Path within repo:** `skills/systematic-debugging/`
...
- The bundle vendored from `skills/systematic-debugging/` is byte-identical to upstream at the SHA above (apart from the frontmatter `license:` insertion noted above).
