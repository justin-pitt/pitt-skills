...
- Vendored the full reference tree (`ci/`, `core/`, `migration/`, `playwright-cli/`, `pom/`) at the recorded SHA so the SKILL.md hub-and-spokes links remain functional inside the plugin.
