...
- Renamed local skill folder from `playwright-skill` (upstream) to `playwright-testing` to match the standalone install Justin already had at `~/.claude/skills/playwright-testing/`. SKILL.md content is byte-identical to upstream.
