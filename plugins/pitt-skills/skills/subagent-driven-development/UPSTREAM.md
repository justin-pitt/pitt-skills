...
- **Path within repo:** `skills/subagent-driven-development/`
...
- The bundle vendored from `skills/subagent-driven-development/` is byte-identical to upstream at the SHA above (apart from the frontmatter `license:` insertion noted above).
